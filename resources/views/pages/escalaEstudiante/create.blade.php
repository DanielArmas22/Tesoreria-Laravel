...
@section('titulo', '')
@section('contenido')
    <section class="shadow-3 border-neutral-400 px-16 py-10 w-10/12 mx-auto flex items-center flex-col gap-2">
        <div class="text-center">
            <h3 class="text-xl">NUEVA ESCALA ESTUDIANTE</h3>
        </div>
        <form method="GET" class="flex items-center flex-col gap-2 justify-center">
        ...
        <form method="POST" action="{{ route('escalaEstudiante.store') }}" class="space-y-4 flex items-center gap-5">
            @csrf
            <div class="p-4">
                ...
                <div class="flex flex-col w-full md:w-3/3 md:pl-4">
                    <div>
                        ...
                        <div class="relative border rounded-md">
                            <select
                                class="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[twe-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-white dark:placeholder:text-neutral-300 dark:autofill:shadow-autofill dark:peer-focus:text-primary [&:not([data-twe-input-placeholder-active])]:placeholder:opacity-0 form-control @error('idEscala') isinvalid @enderror"
                    ...
                    <div class="relative max-w-sm mt-4">
                        ...
                        <input id="datepicker-format" name="fechaEE" value="{{ old('fechaEE') }}" datepicker
                    ...
                    <div class="relative mb-3 mt-4" data-twe-input-wrapper-init>
                        <input type="text"
                            class="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[twe-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-white dark:placeholder:text-neutral-300 dark:autofill:shadow-autofill dark:peer-focus:text-primary [&:not([data-twe-input-placeholder-active])]:placeholder:opacity-0"
                            id="periodo" name="periodo" value="{{ old('periodo') }}" placeholder="periodo"
                            data-twe-input-showcounter="true" maxlength="4" />
                        <label for="periodo"
                    ...
                    <div class="flex space-x-4 pt-4">
                        ...
                        <button
                            ...
                            <a href="{{ route('escalaEstudiante.index') }}">Cancelar</a>
                        </button>
                    </div>
                </div>
            </div>
...
@section('js')
    <script>
        ...
        // Ensure this works when datepicker library triggers date changes
        const datepickerElement = document.querySelector('#datepicker-format');
