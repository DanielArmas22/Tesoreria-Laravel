...
@section('contenido')
    <section class="w-full flex flex-col justify-center items-center">
        @if (session('datos'))
            ...
            @endif
        @endif
        {{-- <article class="flex flex-col items-center gap-2 p-5 rounded-3xl mx-auto w-11/12">
            <h2 class="text-center font-semibold text-xl">Filtros de Busqueda</h2>
            <form class="w-full mb-4" method="GET">
                <div class="flex justify-between pb-2 gap-20 w-full items-center">
                    <div class="w-full flex flex-col gap-4">
                        <x-textField label="Codigo" placeholder="Busqueda por Codigo" name="busquedaCodigo"
                            valor="{{ $busquedaCodigo }}" />
                        <x-textField label="Nombre" placeholder="Busqueda por Nombre" name="busquedaNombre"
                            valor="{{ $busquedaNombre }}" />
                        <x-textField label="DNI" placeholder="Busqueda por DNI" name="busquedaDNI"
                            valor="{{ $busquedaDNI }}" />
                    </div>
                    <div class="w-5/12">
        ...
        <section class="lg:flex gap-4 px-4 py-8 shadow-xl  rounded-3xl border-[1px]">
            <div class="">
                <article class="flex justify-start">
                    <x-button label="Nuevo Estudiante" ruta="estudiante.create" color="success" />
                </article>
                <br>
            ...
            {{-- <form class="form-inline my-2 my-lg-0 flex flex-col gap-2" method="GET">
                <x-textField label="Busqueda por Nombre" placeholder="Busqueda por Nombre" name="busqueda" />
                <button
