...
<div class="max-w-7xl bg-white rounded-lg shadow-md mx-auto">
    ...
    <div class="grid gap-8 grid-cols-1 md:grid-cols-2">
        ...
        <div class="bg-gray-50 p-6 rounded-lg shadow-sm">
            ...
            <form action="{{ route('pago.show') }}" method="GET" class="space-x-4 space-y-5 items-center">
                ...
                <div class="mr-2">
                    <input type="text" name="nombreEstudiante" id="nombreEstudiante"
                        placeholder="Nombre del Estudiante" value="{{ request('nombreEstudiante') }}"
                        class="w-5/6 px-4 py-2 -ml-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                </div>
                <div class="w-5/6 flex space-x-3">
                    <div>
                        <input type="text" name="apellidoPEstudiante" id="apellidoPEstudiante"
                            placeholder="Apellido P" value="{{ request('apellidoPEstudiante') }}"
                            class="w-[90%] px-4 py-2 -ml-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div class="ml-2">
                        <input type="text" name="apellidoMEstudiante" id="apellidoMEstudiante"
                            placeholder="Apellido M" value="{{ request('apellidoMEstudiante') }}"
                            class="w-[90%] px-4 py-2 -ml-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                </div>
        ...
        <form id="pago-form" action="{{ route('pago.store') }}" method="POST">
            ...
            <div class="flex justify-end mt-4 mr-2">
                <button type="submit"
                    ...
                    id="search-button" data-twe-ripple-init data-twe-ripple-color="light">
                    <span class="mx-auto [&>svg]:h-5 [&>svg]:w-5 flex space-x-1 pr-8 py-1">
                        <i class="text-sm ml-8 fa-solid fa-money-check pt-1 pr-2"></i>PAGAR TOTAL
                    </span>
