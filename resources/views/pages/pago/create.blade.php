...
@section('contenido')
            ...
            <div class="grid gap-8 grid-cols-1 md:grid-cols-2">
                ...
                <div class="bg-gray-50 p-6 rounded-lg shadow-sm">
                    ...
                    <div class="flex flex-col space-y-4">
                        ...
                        <div class="flex space-x-4 mb-4">
                            <div class="flex-1">
                                <label for="apellidoP" class="block text-sm font-medium text-gray-700">Apellido
                                    Paterno</label>
                                <input type="text" id="apellidoP" value="{{ $estudiante->apellidoP ?? '' }}"
                                    class="w-full px-4 py-2 border rounded-lg bg-gray-100" readonly>
                            </div>
                            <div class="flex-1">
                                <label for="apellidoM" class="block text-sm font-medium text-gray-700">Apellido
                                    Materno</label>
    ...
    @else
        ...
        <div class="max-w-7xl bg-gray-50 rounded-lg shadow-md mx-auto px-6">
            @if (session('mensaje'))
                <x-alert :mensaje="session('mensaje')" tipo="error" />
            @endif
            <div class="grid gap-8 grid-cols-1 md:grid-cols-2">
                        ...
                        @if (isset($estudiantes))
                            <div class="w-max">
                                <select
                                    ...
                                    <option value="" {{ $idEstudiante == 'ninguno' ? 'Selected' : '' }}>
                                        Estudiante
                                    </option>
                                    @foreach ($estudiantes as $es)
                                        <option value="{{ $es->estudiante->idEstudiante }}"
                                            {{ $idEstudiante == $es->estudiante->idEstudiante ? 'Selected' : '' }}>
                                            {{ $es->estudiante->DNI }} -
