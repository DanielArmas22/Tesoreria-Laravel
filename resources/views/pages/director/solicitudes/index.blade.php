            ...
            <form method="GET" action="" class="flex flex-wrap items-end gap-4">
                ...
                <div>
                    ...
                    <select name="grado" id="grado"
                        class="form-select block w-full px-4 py-2 text-lg rounded-lg border-2 border-gray-300 focus:outline-none">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-100">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">
                                Fecha</th>
                            <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Ver
                            </th>
                            <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">
                                Observaciones</th>
                            <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">
                        ...
                        @else
                            @foreach ($datos as $itemdatos)
                                <tr>
                                    ...
                                    <form action="{{ route('solicitudes.observar', $itemdatos->idCondonacion) }}"
                                    ...
                                    <form action="{{ route('solicitudes.aceptar', $itemdatos->idCondonacion) }}"
                                        method="POST" style="display:inline;">
                                        @csrf
                                        <button type="submit"
