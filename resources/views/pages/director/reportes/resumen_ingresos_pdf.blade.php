...
<body>
    ...
    <h2>Resumen de Ingresos por Grado y Sección</h2>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>${{ number_format($ingreso->total_ingresos, 2) }}</td>
            </tr>
            @empty
            <tr>
    ...
    <h3 class="total-general">Total General de Ingresos: ${{ number_format($totalGeneralIngresos, 2) }}</h3>
