    ...
    <div class="container py-5">
        ...
        <form method="GET" action="" class="mb-5">
            <div class="flex justify-center gap-4 mb-4">
                <div class="w-full md:w-1/3">
                    <select
                        class="form-select block w-full px-4 py-2 text-lg rounded-lg border-2 border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div class="flex gap-3 justify-center">
                <button type="submit"
                    class="w-full md:w-auto px-6 py-3 text-sm font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">Filtrar</button>
                <x-boton label="Limpiar" color="success" ruta="dashboard.index">
        ...
        <div class="flex justify-center gap-4 mt-4">
            <a href="{{ route('dashboard.ingresos') }}"
                class="px-6 py-3 text-lg font-bold text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">Ver
                Ingresos</a>
            <a href="{{ route('dashboard.deudas') }}"
                class="px-6 py-3 text-lg font-bold text-white bg-yellow-500 rounded-lg hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-yellow-500">Ver
                Deudas</a>
            <a href="{{ route('director.reportes.index') }}"
                class="px-6 py-3 text-lg font-bold text-white bg-green-600 rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500">Ver
                Reportes</a>
        </div>
    </div>
@endsection
