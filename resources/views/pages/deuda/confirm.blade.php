...
<section class="shadow-3 border-neutral-400 px-16 pt-14 pb-10">
    <div class="text-center">
        <h3 class="text-xl">ELIMINAR DEUDA</h3>
    </div>
    <form method="POST" action="{{ route('deuda.destroy', $deuda->idDeuda) }}"
        ...
        <div class="p-4">
            <h4 class="text-xl">DATOS DE ESTUDIANTE</h4>
                ...
                <div class="relative mb-3 mt-4" data-twe-input-wrapper-init>
                    ...
                    placeholder="ID Estudiante" value="{{ $deuda->estudiante->nombre }}" readonly
                    data-twe-input-showcounter="true" maxlength="50" />
                ...
                <div class="relative mb-3 mt-4" data-twe-input-wrapper-init>
                    <input type="text" class="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[twe-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-white dark:placeholder:text-neutral-300 dark:autofill:shadow-autofill dark:peer-focus:text-primary [&:not([data-twe-input-placeholder-active])]:placeholder:opacity-0" id="observacion" name="observacion" 
                    placeholder="ID Estudiante" value="{{ $deuda->estudiante->apellidoP }}" readonly
                    data-twe-input-showcounter="true" maxlength="50" />
                    <label for="exampleFormControlInputCounter" class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[twe-input-state-active]:-translate-y-[0.9rem] peer-data-[twe-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-400 dark:peer-focus:text-primary">Apellido Materno</label>
                    <div class="absolute w-full text-sm text-neutral-500" data-twe-input-helper-ref></div>
                </div>
                <div class="relative mb-3 mt-4" data-twe-input-wrapper-init>
                    <input type="text" class="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[twe-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-white dark:placeholder:text-neutral-300 dark:autofill:shadow-autofill dark:peer-focus:text-primary [&:not([data-twe-input-placeholder-active])]:placeholder:opacity-0" id="observacion" name="observacion" 
                    placeholder="ID Estudiante" value="{{ $deuda->estudiante->apellidoM }}" readonly
                    data-twe-input-showcounter="true" maxlength="50" />
                    <label for="exampleFormControlInputCounter" class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[twe-input-state-active]:-translate-y-[0.9rem] peer-data-[twe-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-400 dark:peer-focus:text-primary">Apellido Paterno</label>
                    <div class="absolute w-full text-sm text-neutral-500" data-twe-input-helper-ref></div>
                </div>
        </div>
        @error('idEstudiante')
        ...
        <div class="flex flex-col md:flex-row justify-between space-y-8 md:space-y-0">
            <div class="flex flex-col w-full md:w-3/3 md:pl-4">
                <div class="mb-4">
                    <x-textField label="Codigo" name='idDeuda' valor="{{ $deuda->idDeuda }} " readonly="true" />
                </div>
                <div class="mb-4">
                    <x-textField label="Concepto Escala" name='idConceptoEscala'
                        valor="{{ $deuda->conceptoEscala->descripcion }} " readonly="true" />
                </div>
                <div class="mb-4">
                    <x-textField label="Monto Mora" name='montoMora' valor="{{ $deuda->montoMora }} " readonly="true" />
                </div>
                <div class="mb-4">
                    <x-textField label="Monto total" name='montoTotal' valor="{{ $deuda->conceptoEscala->escala->monto + $deuda->montoMora }}" readonly="true" />
                </div>
                <div class="mb-4">
                    <div class="relative max-w-sm">
                        ...
                        <input value="{{ $deuda->fechaLimite }}" readonly="true" id="datepicker-format" name="fechaLimite"
                ...
                <div class="mb-4">
                    <x-textField label="Adelanto" name='adelanto' valor="{{ $deuda->adelanto }}" readonly="true" />
                </div>
                <div class="flex justify-center space-x-4">
                    <button type="submit" class="{{ $buttonClass }}"><i class="fas fa-save"></i> Confirmar</button>
