...
@section('contenido')
<form method="POST" action="{{ route('condonacion.actualizarCondonacionA', $condonacion->idCondonacion) }}">
    @method('put')
    @csrf
        ...
        <div class="flex flex-col w-1/4 gap-4 border-b-2 border-gray-300 rounded-2xl  shadow-xl">
            ...
            <article>
                <div class="flex flex-col gap-3 p-4 py-8">
                    <div class="flex gap-4 flex-col items-center justify-center">
                        <h3 class="text-xl font-semibold">Condonación Pendiente a Aprobar</h3>
                    </div>
                    {{-- csrf: importante  --}}
