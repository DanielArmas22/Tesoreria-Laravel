...
<body>
    ...
    <main class="font-Montserrat">
        <nav class="fixed top-0 z-50 w-full bg-lime-500 border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    @else
                        <li>
                            <button type="button"
                                ...
                                <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Estudiantes</span>
                        ...
                        @if (!auth::user()->hasRole('padre'))
                            <li>
                                <button type="button"
                                    ...
                                    <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Escala</span>
                                    <svg class="w-3 h-3 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                        fill="none" viewBox="0 0 10 6">
                                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                            stroke-width="2" d="m1 1 4 4 4-4" />
                        ...
                        @if (!Auth::user()->hasRole('director') && !Auth::user()->hasRole('secretario'))
                            <li>
