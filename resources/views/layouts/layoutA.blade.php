...
<body>
    ...
    <main class="font-Montserrat">
        ...
        @if (Auth::user()->usertype == 'admin')
            <nav
                class="fixed top-0 z-50 w-full bg-lime-500 border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                                    ...
                                    <ul class="py-1" role="none">
                                        <li>
                                            <a href="{{ route('home.index') }}"
                                                ...
                                                role="menuitem">Incio</a>
                                        </li>
                                        <li>
                                            @if (session('name') == 'daniel')
                                                <a href="{{ route('login') }}"
                                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-white"
                                                    role="menuitem">Salir</a>
                                            @else
                                                <span
                                                    class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Estudiante</span>
                                            @endif
