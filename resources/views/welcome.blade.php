...
<body class="font-sans antialiased">
    <div class="bg-gray-50 text-black/50">
        ...
        <div
            class="relative min-h-screen flex flex-col items-center justify-center selection:bg-[#2d5c39] selection:text-white">
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <header class="flex flex-col gap-6 items-center  py-10 lg:grid-cols-3">
                    <div class="flex lg:justify-center lg:col-start-2">
                        ...
                        <img src="/img/profileTesoreria.jpg" alt="tesoreria-icon"class="h-12 w-auto lg:h-16">
                    </div>
                    @if (Route::has('login'))
                        <nav class="-mx-3 flex flex-1 justify-end">
                            ...
                            @else
                                ...
                                <a href="{{ route('login.padre') }}"
                                    class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20]">
                                    Iniciar Sesion (Padre)
                                </a>
                                <a href="{{ route('login.tesorero') }}"
                                    class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20]">
                                    Iniciar Sesion (Tesorero)
                                </a>
                                ...
                                @if (Route::has('register'))
                                    ...
                                    <a href="{{ route('register.padre') }}"
                                        class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20]">
                                        Registrarte padre
                                    </a>
                                    <a href="{{ route('register.tesorero') }}"
                                        class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20]">
                                        Registrarte Tesorero
                                    </a>
                                @endif
                            @endauth
                        </nav>
